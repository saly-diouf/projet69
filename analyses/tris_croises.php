...
if ($var1_id && $var2_id && $var1_id != $var2_id) {
    // Récupérer les valeurs des deux variables
    function getQuestionValues($db, $question_id, $etude_id) {
    ...
    $data1 = getQuestionValues($db, $var1_id, $etude_id);
    $data2 = getQuestionValues($db, $var2_id, $etude_id);

    if ($data1 && $data2) {
        // Aligner les répondants
...
<div class="page-header">
    <div>
        <h1>Tris croisés & Test du Khi²</h1>
        <p>Tableaux de contingence et test d'indépendance</p>
    </div>
</div>
...
<div class="card">
    <div class="empty-state">
        ...
        <p>Cette étude ne contient pas de questions de type fermé ou échelle pour les tris croisés.</p>
    </div>
</div>
<?php else: ?>
<div class="card">
    <div class="empty-state">
        ...
        <p>Choisissez deux questions dans les menus déroulants pour générer un tri croisé.</p>
    </div>
</div>
<?php endif; ?>
